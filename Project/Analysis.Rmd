...
library(dplyr)
library(corrplot)
dt <- df %>% select(HighSchoolLess:BachelorAndHigher)
res <- cor(dt)
...
library(MASS)
# Fit the full model 
full.model <- lm(HPI ~ Personal_Income + Poverty_Percentage + Population + HighSchoolLess + HighSchoolOnly + SomeCollege + BachelorAndHigher + Unemployment_Rate, data=df)
