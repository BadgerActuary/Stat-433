...
unemployment = unemployment_raw %>% 
  ...
  separate(area_name, into = c("County", "State2"), sep = " C", extra = "merge") %>% 
...
education = education_raw %>% 
  ...
  separate(Area.name, into = c("County", "County2"), sep = " C", extra = "merge") %>%
...
population = population_raw %>% 
  filter(str_detect(Area_Name, "County")) %>% 
  separate(Area_Name, into = c("County", "County2"), sep = " C", extra = "merge") %>% 
