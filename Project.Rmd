...
education = education_raw %>% filter(str_detect(Area.name, "County")) %>% separate(Area.name, into = c("County", "County2"), sep = "\\s", extra = "merge") %>% select(State, County, `Less.than.a.high.school.diploma..1970`:`Four.years.of.college.or.higher..1970`)
